  ...
  return (
    <div className="my-recept-page">
      ...
      {!isLoading && recipes.length === 0 && !error && (
        <div className="empty-state">
          ...
          <p style={{ color: "var(--muted)", margin: 0 }}>
            Gå till <strong>Skapa Recept</strong> för att lägga till ditt första
            recept.
          </p>
        </div>
      )}
      ...
      {editingRecipe && (
        <div
          className="mr-modal-backdrop"
          onClick={() => !isSaving && closeEdit()}
        >
          <div
            className="mr-modal mr-edit-modal"
          ...
          >
            ...
            {editSuccess && <p className="mr-success">Ändringarna sparades!</p>}
